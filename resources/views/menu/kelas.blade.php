...
<div class="w-full mx-auto px-4 py-8">
    ...
    <div id="kelas-kolom" class="grid grid-cols-1 md:grid-cols-3 gap-12 mx-auto">
        ...
        <div class="bg-mts-bg shadow-md rounded-lg p-6 ">
            ...
            <ul id="mts-list" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Daftar kelas MTS -->
        ...
        <div class="bg-mts-bg shadow-md rounded-lg p-6">
            ...
            <ul id="ma-list" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Daftar kelas MA -->
        ...
        <div class="bg-mts-bg shadow-md rounded-lg p-6">
            ...
            <ul id="smk-list" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Daftar kelas SMK -->
